...
Ditulis ulang: 17 September 2026 (pembaruan kesebelas: halaman RHODL Waves, ingatan kontrol per halaman, tombol Style di dalam chart — dinyatakan valid user dan di-push 17 Sep; CDD/VDD ditunda).
...
- **Posisi sekarang (17 Sep 2026):** sembilan halaman dalam lima kelompok menu — Valuation (MVRV, Price Levels, AVIV), Profitability (SOPR, NUPL, Supply in Profit), Holder Behavior (RHODL Waves), Derivatives (Funding Rates & Open Interest), Sentiment & Macro (Fear & Greed). Semuanya dengan slider rentang (bagian 3.2), nyaman di HP (bagian 3.15), kontrol diingat per halaman dan tombol Style di chart (bagian 3.24). **Pekerjaan berikutnya: belum dipilih** — tanyakan user (sisa kandidat bagian 3.23; CDD/VDD ditunda, bagian 3.25). Halaman baru tinggal menambah `MetricFamily` dengan `group` dan `url_path`.
...
### 3.26 Halaman RHODL Waves — SELESAI 17 Sep 2026 (valid menurut user, di-push)
...
- **Catatan kecil yang sudah dilaporkan, belum diminta diubah:** tombol Highlight tinggal None dan BTC; tombol Style tetap muncul walau halaman ini tanpa smoothing; angka sumbu tertulis 100.0 / 90.0 (satu desimal); judul tetap "RHODL Waves" walau saklar di Supply.
...
| `data_hodl_waves.csv` ✅ dipakai (RHODL Waves) | btc_price, lalu `supply_<band>` dan `realized_cap_<band>` untuk **12** band: 0-1d, 1d-1w, 1w-1m, 1m-3m, 3m-6m, 6m-12m, 1y-2y, 2y-3y, 3y-5y, 5y-7y, 7y-10y, 10y+ |
