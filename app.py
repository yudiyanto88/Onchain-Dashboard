...
if selected_menu == "Price Levels":
    if not df_price_raw.empty:
        ...
        # PEMISAHAN 2 SKALA: BTC Kanan, Metrik On-Chain Kiri
        chart_p_opts = {"layout": {"textColor": '#d1d4dc', "background": {"type": 'solid', "color": '#131722'}}, "grid": {"vertLines": {"color": "rgba(42,46,57,0.3)"}, "horzLines": {"color": "rgba(42,46,57,0.3)"}}, "crosshair": {"mode": 0}, "height": 850 if focus_p else 650, "rightPriceScale": {"visible": True}, "leftPriceScale": {"visible": True}}
