"""Dashboard v2 — percobaan satu halaman metrik.

Berdiri sendiri di samping app.py. Jalankan dengan:
...
with st.sidebar:
    ...
    st.markdown("---")
    st.caption("Experimental build. The old dashboard still runs on port 8501.")
