...
| 2026-07-12 | Riset internal (chat, follow-up dari video whale-accumulation) | Apparent Demand: interpretasi kondisional per zona Z1-Z5 (positif di Z5=bearish, negatif di Z1=bullish, dst) | **REJECT** — 1 MIXED, 2 NOT-SUPPORTED (termasuk arah terbalik), 1 MIXED/redundan dengan efek zona yang sudah ada; trend-menurun-di-ATH juga NOT-SUPPORTED | `apparent_demand_hypothesis_findings.md` § H4 |
| 2026-07-12 | Riset internal (chat, uji final) | Apparent Demand: mekanisme diverifikasi presisi (window harian, korelasi 0.9943 vs formula asli), lalu diuji versi murni `change_1y_plus` (terisolasi dari issuance) sebagai kandidat K1 top-signal | **REJECT PERMANEN — investigasi ditutup** — MIXED/condong NOT-SUPPORTED, kuat cuma di cycle pre-2020 (66% dari n), kebalikan arah di 2021 & 2025. Total 6 framing berbeda semua gagal. Jangan uji ulang kecuali ada hipotesis genuinely baru | `apparent_demand_hypothesis_findings.md` (verifikasi mekanisme + § K1 uji final) |
...
|---------|-------|----------------------|---------------|
| 2026-07-11 | On-Chain Mind — "Bitcoin Whales Are Accumulating Right Now" (2025-01-27) | Whale/small-holder divergence (masih NEEDS-MORE-DATA, data whale-by-wallet-size tidak kita punya); apparent demand — data ditarik & diuji lanjut, **REJECT** (n=26, rapuh lintas cycle, leave-one-out swing 3%→84%; lanjut diuji 2026-07-12 versi kondisional-per-zona, juga REJECT — lihat seed table); realized profit $ turun (REJECT — kontradiksi KB SOPR); trader profit margin ~NUPL (REJECT — redundan KB NUPL) | `video_whale-accumulation-2025_findings.md`, `apparent_demand_hypothesis_findings.md` |
| 2026-07-12 | On-Chain Mind — "How to Use the Fear & Greed Index for Bitcoin" (2025-02-23) | F&G SMA30 sebagai refinement trigger K5 — **REJECT** (kehilangan 60% sinyal genuine raw F&G<50, sisanya cuma versi telat 15-32 hari); F&G peak-sebelum-price-top sebagai sinyal ke-6 K1 — **REJECT** (pola turun di ATH baru cuma 53%, coin-flip; satu-satunya cycle matang 2021 malah berlawanan arah) | `video_fear-greed-index_findings.md` |
| 2026-07-12 | On-Chain Mind — "Bitcoin Miners Are Signaling a BIG Move!" | 9 klaim seputar Miners Sentiment Indicator, MPI, Hash Ribbons, Difficulty Ribbon, Puell Multiple — semua **OUT-OF-SCOPE** (data miner-side tidak ada di CSV kita, tidak ada padanan di K1-K6); 0 NOVEL, 0 diuji | `video_miners-signaling-big-move_findings.md` |
